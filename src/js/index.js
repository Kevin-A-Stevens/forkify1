// Make project better ideas
// 1. Implement button to delete all shopping items
...
// Search Controller
const controlSearch = async () => {  // Need async here due to await below
    ...
    if (query) {
        ...
        try {
            ...
            await state.search.getResults(); // await needs to be inside async function
